...
BUNDLED_MODIFICATION_OPTIONS: List[Dict[str, Any]] = [
    ...
    {
        "ontology_id": "UNIMOD:1224",
        "name": "Trp->Ala substitution",
        "label": "Trp->Ala substitution",
        "value": "UNIMOD:1224",
        "kind": "ontology",
        "mode": "variable",
        "residues": ["W"],
        "term_specificity": "none",
        "mass_shift": -115.042199,
        "classification": "AA substitution",
        "description": "Tryptophan to Alanine substitution; misacylation/editing of charged tRNA",
        "aliases": [
            "substitution",
            "aa substitution",
            "trp ala substitution",
            "tryptophan to alanine substitution",
            "misacylation",
            "editing of charged tRNA",
            "1224",
        ],
        "search_terms": [
            "substitution",
    ...
    {
        "ontology_id": "UNIMOD:1239",
        "name": "Tyr->Gly substitution",
        "label": "Tyr->Gly substitution",
        "value": "UNIMOD:1239",
        "kind": "ontology",
        "mode": "variable",
        "residues": ["Y"],
        "term_specificity": "none",
        "mass_shift": -106.041865,
        "classification": "AA substitution",
        "description": "Tyrosine to Glycine substitution; misacylation/editing of charged tRNA",
        "aliases": [
            "substitution",
            "aa substitution",
            "tyr gly substitution",
            "tyrosine to glycine substitution",
            "misacylation",
            "editing of charged tRNA",
            "1239",
        ],
