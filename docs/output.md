...
- `experimental_design/`: Contains experimental design files, OpenMS configs, and other configuration files generated from YAML validation
...
├── experimental_design/       # Experimental design files and configs
...
- `params_<timestamp>.json` containing the command line provided parameters.

</details>

> Note. Parameters specified in the YAML manifest take precedence over command-line equivalents.
>
> - labelling_type
> - dissociationmethod
> - fixedmodifications
